...
[Wopt]=fmincon(@(W) airfoilfit(W,yt,XL,XU,0,A,ind),Winit,[],[],[],[],ones(1,8)*-1,ones(1,8),[]);
...
[ycoord,yl,yu] = CST_airfoil_fit(Wopt,x_lower,x_Upper,dz,A,ind); % Airfoil generated from CST weights
